<?php
    if(!empty($_POST["nombre_producto"]) && !empty($_POST["precio_producto"]) && !empty($_POST["descripcion_producto"])){
        ...
        $query = "INSERT INTO productos (nombre_producto, precio_producto, descripcion_producto) VALUES ('".$_POST["nombre_producto"]."', '".$_POST["precio_producto"]."', '".$_POST["descripcion_producto"]."')";
...
<div class="container">
    <h1 class="text-center mb-4 text-light">Agregar Juego</h1>
